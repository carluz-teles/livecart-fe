...
export const eventKeys = {
  ...
  commentsRoot: (storeId: string, eventId: string) => [...eventKeys.all, "detail-comments", storeId, eventId] as const,
  detailComments: (storeId: string, eventId: string, sessionId?: string) => [...eventKeys.commentsRoot(storeId, eventId), sessionId ?? "todas"] as const,
