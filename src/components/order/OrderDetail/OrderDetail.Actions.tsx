    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          {/* O "confirmar pagamento manual" saiu.
              Dinheiro que entra por fora — maquininha, transferência, espécie —
              o lojista lança no Tiny, que leva o pedido para "Aprovado", e o
              LiveCart segue sozinho. Antes ele tinha de repetir o gesto nos dois
              lugares, e os dois divergiam sempre que ele esquecia um. */}
          {canCancel && (
            <>
              <DropdownMenuSeparator />
              <DropdownMenuItem
